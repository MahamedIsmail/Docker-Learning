...
This project marks my first time into docker. The **goal** was simple build a landing page that successfully displays the current version of an SQL database, proving a successful connection between two isolated services.
